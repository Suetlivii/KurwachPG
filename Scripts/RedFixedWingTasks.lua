...
red01_task = 
{
    ...
    badEndTrigeer = "10103",
    cancelTrigger = "10104",
    startMsgFriendly = [[01."Старая Классика"
Турецкие скоростные лодки захватили танкер в квадрате DQ57. Уничтожить их!
...
red02_task = 
{
    ...
    badEndTrigeer = "10203",
    cancelTrigger = "10204",
    startMsgFriendly = [[02."Remove Kebab"
Разведка сообщает, что колонна техники ОАЭ движется из DP06 в район Аэродрома Khasab (DP-19), чтобы обеспечить плацдарм для наступления. Сделайте так, чтобы колонна не доехала.
...
red03_task = 
{
    ...
    badEndTrigeer = "10303",
    cancelTrigger = "10304",
    startMsgFriendly = [[03."Островное приключение"
...
red04_task = 
{
    ...
    badEndTrigeer = "10403",
    cancelTrigger = "10404",
    startMsgFriendly = [[04."D-Fail"
Арабская Коалиция высадила морской десант в квадрате CQ23. Разведка сообщила, что высадку прикрывает фрегат типа Perry.
...
red05_task = 
{
    ...
    badEndTrigeer = "10503",
    cancelTrigger = "10504",
    startMsgFriendly = [[05."Вмешательство"
...
red06_task = 
{
    ...
    badEndTrigeer = "10603",
    cancelTrigger = "10604",
    startMsgFriendly = [[06."Морская Охота"
...
red07_task = 
{
    ...
    badEndTrigeer = "10703",
    cancelTrigger = "10704",
    startMsgFriendly = [[07."Портовые шлюхи"
...
red08_task = 
{
    ...
    badEndTrigeer = "10803",
    cancelTrigger = "10804",
    startMsgFriendly = [[08."Месть Сладка"
...
red09_task = 
{
    ...
    badEndTrigeer = "10903",
    cancelTrigger = "10904",
    startMsgFriendly = [[09."Глубокое проникновение"
...
red11_task = 
{
    ...
    badEndTrigeer = "11103",
    cancelTrigger = "11104",
    startMsgFriendly = [[11."Безумие Сири"
...
red12_task = 
{
    ...
    badEndTrigeer = "11203",
    cancelTrigger = "11204",
    startMsgFriendly = [[12."Опасный копьеносец"
...
red13_task = 
{
    ...
    badEndTrigeer = "11303",
    cancelTrigger = "11304",
    startMsgFriendly = [[13."Прихлопнуть мотылька"
...
red14_task = 
{
    ...
    badEndTrigeer = "11403",
    cancelTrigger = "11404",
    startMsgFriendly = [[14."Пни малыша"
...
red15_task = 
{
    ...
    badEndTrigeer = "11503",
    cancelTrigger = "11504",
    startMsgFriendly = [[15."Падение черного ястреба"
...
red16_task = 
{
    ...
    badEndTrigeer = "11603",
    cancelTrigger = "11604",
    startMsgFriendly = [[16."Буйство Лебедя"
...
red17_task = 
{
    ...
    badEndTrigeer = "11703",
    cancelTrigger = "11704",
    startMsgFriendly = [[17."Наказать кошечку"
...
red18_task = 
{
    ...
    badEndTrigeer = "11803",
    cancelTrigger = "11804",
    startMsgFriendly = [[18."Эрдоган уходи"
...
red19_task = 
{
    ...
    badEndTrigeer = "11903",
    cancelTrigger = "11904",
    startMsgFriendly = [[19."Укротитель торнадо"
...
red21_task = 
{
    ...
    badEndTrigeer = "12103",
    cancelTrigger = "12104",
    startMsgFriendly = [[21."Grand Theft Aero!"
...
red25_task = 
{
    ...
    badEndTrigeer = "12503",
    cancelTrigger = "12504",
    startMsgFriendly = [[25."Плохая идея"
Агент сообщает! К северо-западу от городка Al Ima (Северная чать DP46), стоит большой склад. В нем складируют оружие для диверсионных отрядов. Плохая идея держать все в одном здании...

25."Bad Idea"
Agent reports! To the northwest of the town of Al Ima (Northern Part DP46), there is a large warehouse. It stores weapons for sabotage units. It’s a bad idea to keep everything in one building ...]],
    startMsgEnemy = "",
    goodEndMsgFriendly = 'Задача выполнена! Mission complete!',
    goodEndMsgEnemy = "",
    badEndMsgFriendly = "Миссия провалена! / Mission failed!",
...
table.insert(redFixedWingTasksConfig, red03_task)
table.insert(redFixedWingTasksConfig, red04_task)
table.insert(redFixedWingTasksConfig, red05_task)
table.insert(redFixedWingTasksConfig, red06_task)
