...
red01_task = 
{
    ...
    badEndTrigeer = "10103",
    cancelTrigger = "10104",
    startMsgFriendly = [["Старая Классика"
...
red03_task = 
{
    ...
    badEndTrigeer = "10303",
    cancelTrigger = "10304",
    startMsgFriendly = [["Островное приключение"
...
Разведка сообщила - К северу от города Дубаи (Квадрат CP), стоит на рейде УРО класса "Тикондерога". Вы знаете что делать, Джентльмены!]],
    startMsgEnemy = "",
